...
import 'package:modsport/utilities/enable/empty_disable_res.dart';
import 'package:modsport/utilities/enable/error_message.dart';
import 'package:modsport/utilities/enable/time_slot_loading.dart';
                ...
                children: [
                  ...
                  isEverythingLoaded() && !_isError
                      ? _disabledReservation.isNotEmpty
                          ...
                          : const Expanded(
                              child: EmptyDisableReservation(),
                            )
                      : _isError
                          ? const Expanded(
                              child: EnableErrorMessage(),
                            )
                          : const Expanded(
                              child: EditTimeSlotLoading(),
                            ),
                ],
              ),
            ),
